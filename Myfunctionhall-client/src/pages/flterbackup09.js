...
function fetchsinglehall() {
    axios.get('http://127.0.0.1:8000/api/hallshow/' + cid)
        .then((res) => {
            ...
            // Filter the halls based on selectedCategories
            const filteredData = data.filter((hall) =>
                selectedCategories.includes(hall.category_id)
            );
                ...
                {categories.map((category) => (
                    <li key={category.id}>
                        <label>
                            ...
                            />
                         <a href={'/Category/'+category.id} ><span className='ml-2'>{category.name}</span></a>   
                        </label>
                    </li>
                ))}
            </ul>
                        ...
                        <div className="row">
                            <div className="col-md-5">
                                <div className="btn-group" role="group">
                                    <button type="button" className="btn btn-secondary active"><i className="fa fa-th"></i></button>
                                    <button type="button" className="btn btn-secondary"><i className="fa fa-th-list"></i></button>
