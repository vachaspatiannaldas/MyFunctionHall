...
function WaterEdit() {
  ...
  function updatedata() {
    axiosInstance.get('http://127.0.0.1:8000/api/Water/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
  ...
  function updateCategory(e) {
    ...
    axiosInstance.put('http://127.0.0.1:8000/api/Water/' + id, datacode)
      .then((resp) => {
          ...
          <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="fw-bold py-3 mb-4">
                <span className="text-muted fw-light">Waterraphy Edit/</span>
              </h4>
              <div className="row">
                <div className="col-xl">
                  <div className="card mb-4 col-md-6">
                    <div className="card-header d-flex justify-content-between align-items-center">
                      <h5 className="mb-0">Waterraphy </h5>
