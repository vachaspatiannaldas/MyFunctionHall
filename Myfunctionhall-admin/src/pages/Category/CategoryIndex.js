...
function CategoryIndex() {
  ...
  function deletedata(id) {
    axiosInstance.delete('http://127.0.0.1:8000/api/Category/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
                          ...
                          {Showdata.map((row) => {
                            return (
                              <tr key={row.id}>
                                <td>{row.name}</td>
                                <td>
                                <img src={`http://localhost:8000/Category_upload/${row.image}`}
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a  className='btn btn-primary' href={'/categoryedit/'+row.id}>Edit</a>
