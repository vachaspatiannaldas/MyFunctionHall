...
function CateringIndex() {
  const [Showdata, setShowdata] = useState([]);

  function fetchData() {
    axiosInstance.get('http://127.0.0.1:8000/api/Catering')
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axiosInstance.delete('http://127.0.0.1:8000/api/Catering/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
          ...
          window.location.href = '/cateringindex';
        } else {
          console.log('Sorry');
                              ...
                              <tr key={row.id}>
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <a  class="dropdown-item" href="javascript:void(0);" href={'/cateringEdit/'+row.id}>Edit</a>
