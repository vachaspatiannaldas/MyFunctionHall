...
function DecorationEdit(props) {
  ...
  function fetchDecorationData() {
    axiosInstance
      .get(`http://127.0.0.1:8000/api/Decoration/${id}`)
      .then((res) => {
        const data = res.data;
        setName(data.name);
        setType(data.type);
  ...
  function updateDecoration(e) {
    ...
    axiosInstance
      .post(`http://127.0.0.1:8000/api/Decoration/${id}`, formData, {
                  ...
                  <div className="col-xl">
                    <div className="card mb-4 col-md-6">
                      ...
                      <form onSubmit={updateDecoration}>
                        ...
                        <button type="button" class="btn btn-info"  onClick={updateDecoration}>Update</button>
                      </form>
                      </div>
                    </div>
                  </div>
