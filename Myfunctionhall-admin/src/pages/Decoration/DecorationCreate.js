...
function DecorationCreate() {
  ...
  function handleSubmit(e) {
    ...
    axiosInstance
      .post('http://127.0.0.1:8000/api/Decoration', data, {
            ...
            <div className="content-wrapper">
              <div className="container-xxl flex-grow-1 container-p-y">
                <h4 className="fw-bold py-3 mb-4">
                  <span className="text-muted fw-light">DecorationCreates/</span> Vertical Layouts
                </h4>
                <div className="row">
...
export default DecorationCreate;
