...
function Myprofile() {
  ...
  //update perticular profile
  
  // function perticularuser() {
  //   axiosInstance
  //     .get(`http://127.0.0.1:8000/api/perticularuser/${id}`)
  //     .then((res) => {
  //       // const data = res.data;        
    ...
    axiosInstance
      ...
      .then((resp) => {
        ...
        if (resp && resp.data && resp.data.status === 'success') {
          ...
          window.location.href = '/myprofiledetails';
        } else {
      ...
      <div className="layout-wrapper layout-content-navbar">
        ...
        <div class="row">
            <div class="col-md-12 mb-5">
                <img  src={`http://localhost:8000/profile_upload/${banner}`}  alt="" class="bgimg"/>
               <div class="row row2">
                <div className='col-md-2'>
                    <img  src={`http://localhost:8000/profile_upload/${image}`}  alt="" srcset="" class="img2"/>
                </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div className="mb-3">
    ...
    <img src={`http://localhost:8000/profile_upload/${image}`} 
  ...
  <img src={`http://localhost:8000/profile_upload/${banner}`} 
                                alt="#" style={{width:"380px",height:"290px",marginTop:"40px",marginLeft:"40px"}}/>
  ...
  {Showdata.map((row) => {
    if (selectedCategories.includes(row.name)) {
      return (
        <span key={row.id} className="badge bg-primary mx-1">
          {row.name}
        </span>
      );
    }
