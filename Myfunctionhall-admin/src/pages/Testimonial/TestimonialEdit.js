...
function TestimonialEdit(props) { 
  ...
  function fetchtestimonialData() {
    axios
      .get(`http://127.0.0.1:8000/api/testimonial/${id}`)
      .then((res) => {
        const data = res.data;
        setName(data.name);
        setImage(data.image);
  ...
  function updatetestimonial(e) {
    ...
    axios
      .post(`http://127.0.0.1:8000/api/testimonial/${id}`, formData, {
                  ...
                  <div className="col-xl">
                    <div className="card mb-4 col-md-6">
                      ...
                      <form onSubmit={updatetestimonial}>
                        ...
                        <button type="button" class="btn btn-info"  onClick={updatetestimonial}>Update</button>
                      </form>
                      </div>
                    </div>
                  </div>
