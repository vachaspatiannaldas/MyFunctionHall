...
function MarketingIndex() {
  ...
  function fetchData() {
    axiosInstance.get('http://127.0.0.1:8000/api/Marketing')
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axiosInstance.delete('http://127.0.0.1:8000/api/Marketing/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
            ...
            <div className="content-wrapper">
              <div className="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                  ...
                  <h5 class="card-header">Marketing Table</h5>
                  <div class="card-body">
        ...
        <td>
          <div class="dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href={'/marketingedit/' + row.id}>
