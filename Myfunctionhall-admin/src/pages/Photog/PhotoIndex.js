...
function PhotoIndex() {
  ...
  function fetchData() {
    axios.get('http://127.0.0.1:8000/api/Photog',config)
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axios.delete('http://127.0.0.1:8000/api/Photog/' + id,config)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
                                ...
                                <td>
                                  <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu">
                                      <a className="dropdown-item" href="javascript:void(0);" href={'/photoedit/' + row.id}>Edit</a>
