...
function PhotoEdit() {
  ...
  function updatedata() {
    axiosInstance.get('http://127.0.0.1:8000/api/Photog/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
  ...
  function updateCategory(e) {
    ...
    axiosInstance.put('http://127.0.0.1:8000/api/Photog/' + id, datacode)
      .then((resp) => {
          ...
          <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="fw-bold py-3 mb-4">
                <span className="text-muted fw-light">Photography Edit/</span>
              </h4>
              <div className="row">
