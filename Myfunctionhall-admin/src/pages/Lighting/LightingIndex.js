...
function LightingIndex() {
  ...
  function fetchData() {
    axiosInstance.get('http://127.0.0.1:8000/api/Lighting')
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axiosInstance.delete('http://127.0.0.1:8000/api/Lighting/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
                              ...
                              <tr key={row.id}>
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <a  class="dropdown-item" href="javascript:void(0);" href={'/lightingedit/'+row.id}>Edit</a>
