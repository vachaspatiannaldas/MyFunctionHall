...
function LightingEdit() {
  ...
  function updatedata() {
    axiosInstance.get('http://127.0.0.1:8000/api/Lighting/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
  ...
  function updateCategory(e) {
    ...
    axiosInstance.put('http://127.0.0.1:8000/api/Lighting/' + id, datacode)
      .then((resp) => {
        ...
        if (data[0].status === "success") {
          ...
          window.location.href = '/lightingindex';
        } else {
          console.log("Error");
          ...
          <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="fw-bold py-3 mb-4">
                <span className="text-muted fw-light">LightingEdits/</span> Vertical Layouts
              </h4>
              <div className="row">
