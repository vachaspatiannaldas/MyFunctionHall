...
function MakeupIndex() {
  ...
  function fetchData() {
    axiosInstance.get('http://127.0.0.1:8000/api/Makeup')
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axiosInstance.delete('http://127.0.0.1:8000/api/Makeup/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
            ...
            <div className="content-wrapper">
              <div className="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                  ...
                  <h5 class="card-header">Makeup Table</h5>
                  <div class="card-body">
                            ...
                            return (
                              <tr key={row.id}>
                               <td>{row.bname}</td>
                                ...
                                <td>{row.details}</td>
                                <td>
                                <img src={`http://localhost:8000/makeup_upload/${row.image}`} 
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      <a class="dropdown-item" href={'/makeupedit/'+row.id}>
                                        <i class="bx bx-edit-alt me-1"></i> Edit
                                      </a>
                                      {/* <a  className='btn btn-primary' href={'/makeupedit/'+row.id}>Edit</a> */}
