...
function VideoIndex() {
  ...
  function fetchData() {
    axiosInstance.get('http://127.0.0.1:8000/api/Videog')
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axiosInstance.delete('http://127.0.0.1:8000/api/Videog/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
                                ...
                                <td>
                                  <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu">
                                      <a className="dropdown-item" href="javascript:void(0);" href={'/videoedit/' + row.id}>Edit</a>
