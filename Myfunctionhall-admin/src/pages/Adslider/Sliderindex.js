...
function Sliderindex() {
  ...
  function fetchData() {
    axios.get('http://127.0.0.1:8000/api/Adslider',config)
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axios.delete('http://127.0.0.1:8000/api/Adslider/' + id,config)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-menu">
      ...
      <a className='btn btn-primary' href={'/editslider/'+row.id}>Edit</a>
