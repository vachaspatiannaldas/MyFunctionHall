...
function PackageCreate() {
  ...
  function handleSubmit(e) {
    ...
    axios
      .post('http://127.0.0.1:8000/api/Package', data, {
            ...
            <div className="content-wrapper">
              <div className="container-xxl flex-grow-1 container-p-y">
                <h4 className="fw-bold py-3 mb-4">
                  <span className="text-muted fw-light">PackageCreates/</span> Vertical Layouts
                </h4>
                <div className="row">
                  <div className="col-xl">
                    <div className="card mb-4 col-md-6">
                      ...
                      <form>
                        ...
                        <div className="mb-3">
                          <label className="form-label" for="basic-icon-default-fullname">Days</label>
                        ...
                        <div className="mb-3">
                          <label className="form-label" for="basic-icon-default-company">Amount</label>
                          <div className="input-group input-group-merge">
