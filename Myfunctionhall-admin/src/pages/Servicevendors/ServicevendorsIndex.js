...
function ServicesvendorsIndex() {
  ...
  function deletedata(id) {
    axios.delete('http://127.0.0.1:8000/api/Servicevendors/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
          ...
          window.location.href = '/servicevendorssindex';
        } else {
          console.log('Sorry');
                          ...
                          {Showdata.map((row) => {
                            return (
                              <tr key={row.id}>
                                ...
                                <td>{row.ownername}</td>
                                <td>
                                <img src={`http://localhost:8000/servicevendors_upload/${row.image}`}
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a  className='btn btn-primary' href={'/servicevendorsedit/'+row.id}>Edit</a>
...
export default ServicesvendorsIndex;
