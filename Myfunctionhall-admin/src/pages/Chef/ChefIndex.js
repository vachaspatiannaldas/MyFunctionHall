...
function ChefIndex() {
  ...
  function fetchData() {
    axiosInstance.get('http://127.0.0.1:8000/api/Chef')
      .then((res) => {
        const data = res.data;
        console.log(data);
        setShowdata(data);
  ...
  function deletedata(id) {
    axiosInstance.delete('http://127.0.0.1:8000/api/Chef/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
                          ...
                          {Showdata.map((row) => {
                            return (
                              <tr key={row.id}>
                                ...
                                <td>{row.type}</td>
                                <td>
                                <img src={`http://localhost:8000/chef_upload/${row.image}`} 
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a  className='btn btn-primary' href={'/chefedit/'+row.id}>Edit</a>
