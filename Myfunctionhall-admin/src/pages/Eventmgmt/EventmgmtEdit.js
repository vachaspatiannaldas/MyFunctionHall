...
function EventmgmtEdit() { 
  ...
  function updatedata() {
    axiosInstance.get('http://127.0.0.1:8000/api/Eventmgmt/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
  ...
  function updateCategory(e) {
    ...
    axiosInstance.put('http://127.0.0.1:8000/api/Eventmgmt/' + id, datacode)
      .then((resp) => {
          ...
          <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
              <h4 className="fw-bold py-3 mb-4">
                <span className="text-muted fw-light">EventmgmtEdits/</span> Vertical Layouts
              </h4>
              <div className="row">
