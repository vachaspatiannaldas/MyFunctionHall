...
function ServicesIndex() {
  ...
  function deletedata(id) {
    axios.delete('http://127.0.0.1:8000/api/Service/' + id)
      .then((res) => {
        const data = res.data;
        console.log(data);
        if (data) {
                          ...
                          {Showdata.map((row) => {
                            return (
                              <tr key={row.id}>
                                <td>{row.name}</td>
                                <td>
                                <img src={`http://localhost:8000/service_upload/${row.image}`} 
                                ...
                                <td>
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a  className='btn btn-primary' href={'/serviceedit/'+row.id}>Edit</a>
